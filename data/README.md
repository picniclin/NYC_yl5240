The clean process could be found on [civic_clean_descripitive_Yuwei.ipynb](https://github.com/picniclin/NYC_yl5240/blob/master/civic_clean_descripitive_Yuwei.ipynb)
